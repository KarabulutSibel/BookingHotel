		...
		public async Task<IActionResult> Index(string cityId)
		{
			if (!string.IsNullOrEmpty(cityId))
			{
				...
				var request = new HttpRequestMessage
				{
					...
					RequestUri = new Uri($"https://booking-com.p.rapidapi.com/v2/hotels/search?room_number=1&adults_number=2&checkout_date=2024-04-28&filter_by_currency=EUR&units=metric&locale=en-gb&checkin_date=2024-04-24&dest_type=city&dest_id={cityId}&order_by=popularity&children_ages=5%2C0&children_number=2&include_adjacency=true&categories_filter_ids=class%3A%3A2%2Cclass%3A%3A4%2Cfree_cancellation%3A%3A1&page_number=0"),
					Headers =
	{
